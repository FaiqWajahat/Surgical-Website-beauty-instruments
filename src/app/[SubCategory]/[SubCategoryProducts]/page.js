...
const SubCategoryProducts = () => {
  ...
  useEffect(() => {
    const filteredProducts = productData.filter(
      v => v.subcategory.toLowerCase() === subCategoryName.toLowerCase()
    )
  ...
  return (
    <div className="min-h-screen">
      ...
      <section className="relative bg-blue-950 text-white py-24 px-6 lg:px-20 text-center">
        ...
        >
          Explore our precision-crafted {subCategoryName ?? ""} designed to
          provide unmatched performance and comfort for healthcare professionals
          worldwide.
        </motion.p>
      </section>
