  ...
  const MENUS = [
    {
      ...
      label: "Surgical",
      items: [
        { name: "Scalpels", desc: "Sharp precision blades" },
        { name: "Splinter Forceps", desc: "Precise tissue grip" },
        { name: "Scissors", desc: "Accurate tissue cutting" },
        { name: "Towel & Tubing Clamps", desc: "Secure flow control" },
        { name: "Sutures", desc: "Hold suture needles" },
        { name: "Rhinologys", desc: "Nasal surgery tools" },
      ],
    },
    {
      id: "scissors",
      label: "Scissors",
      items: [
        { name: "Titanium Coated Hair Scissors", desc: "Precision hair cutting" },
        { name: "Thinning Scissors", desc: "Smooth hair thinning" },
        { name: "Hair Cutting Scissors", desc: "Sharp clean cuts" },
        { name: "Economy Hair Thinning Scissors", desc: "Affordable hair thinning" },
        { name: "Cuticle & Personal Care Scissors", desc: "Cuticle care trimming" },
        { name: "Barracuda Hair Scissors", desc: "Professional hair styling" },
      ],
    },
    {
      id: "tweezers",
      label: "Tweezers",
      items: [
        { name: "Adson Tweezers", desc: "Delicate tissue handling" },
        { name: "Dressing Tweezers", desc: "Apply surgical dressings" },
        { name: "Splinter Tweezers", desc: "Remove small splinters" },
        { name: "Fine Tip Tweezers", desc: "Precision tissue grip" },
        { name: "Flat Tip Tweezers", desc: "Hold wide objects" },
        { name: "Curved Tweezers", desc: "Angled tissue handling" },
      ],
    },
    {
      id: "razors",
      label: "Razors",
      items: [
        { name: "Barber Razors", desc: "Straight edge razor" },
        { name: "Thinning Razors", desc: "Hair texturing razor" },
        { name: "Bone and Horn Razors", desc: "Bone handle razor" },
        { name: "Damascus Razors", desc: "Damascus steel blade" },
        { name: "Plastic Handle Razors", desc: "Plastic grip razor" },
        { name: "Wood Handle Razors", desc: "Wooden grip razor" },
      ],
    },
  ];
    ...
    >
                  ...
                  >
                    <div className="grid grid-cols-2 gap-4 p-4">
                      {menu.items.map((it) => (
                        <Link
                          key={it.name}
                          href={`/${menu.label}/${it.name.replace(/\s+/g, "-")}`}
                          role="menuitem"
      ...
      >
        <div className="px-6 py-4 flex flex-col space-y-4">
          ...
          {MENUS.map((menu) => {
            ...
            return (
              <div key={menu.id}>
                ...
                <div
                  className={`mt-2 pl-4 space-y-2 transition-all ${
          ...
          <Link
            href="/Contact"
            className="w-full px-4 py-2 text-center bg-blue-700 text-white font-medium rounded-md"
            onClick={() => setMobileOpen(false)}
          >
            Contact Us
          </Link>
